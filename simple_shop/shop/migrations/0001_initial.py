...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('group_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='auth.group')),
                ('group_name', models.CharField(default='SELLERS', max_length=15)),
            ],
            bases=('auth.group',),
            managers=[
                ('objects', django.contrib.auth.models.GroupManager()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.orderlist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_list', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='shop.orderlist')),
            ],
            options={
                'abstract': False,
            },
